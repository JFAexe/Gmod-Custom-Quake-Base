...
AddSVConv('cqb_sv_hitreg_compensation', 1, 0, 1)
...
if CLIENT then
    ...
    local function ServerMenu(panel)
        ...
        panel:Help('Misc')
        panel:CheckBox('Hitreg compensation', 'cqb_sv_hitreg_compensation')
        panel:ControlHelp('Doesn\'t work in Single Player\nMakes bullets react on hulls')
    end
